...
### [13] [Introducing WARM-VR: Benchmark Dataset for Multimodal Wearable Affect Recognition in Virtual Reality](https://arxiv.org/abs/2605.00184)
...
### [14] [Learning Fingerprints for Medical Time Series with Redundancy-Constrained Information Maximization](https://arxiv.org/abs/2605.00130)
...
### [15] [Smart Profit-Aware Crop Advisory System: Kisan AI](https://arxiv.org/abs/2605.00133)
...
### [26] [Jailbroken Frontier Models Retain Their Capabilities](https://arxiv.org/abs/2605.00267)
...
### [27] [Pessimism-Free Offline Learning in General-Sum Games via KL Regularization](https://arxiv.org/abs/2605.00264)
...
### [28] [Polaris: Coupled Orbital Polar Embeddings for Hierarchical Concept Learning](https://arxiv.org/abs/2605.00265)
...
### [32] [VQ-SAD: Vector Quantized Structure Aware Diffusion For Molecule Generation](https://arxiv.org/abs/2605.00354)
...
### [33] [A Dirac-Frenkel-Onsager principle: Instantaneous residual minimization with gauge momentum for nonlinear parametrizations of PDE solutions](https://arxiv.org/abs/2605.00284)
...
### [37] [Federated Weather Modeling on Sensor Data](https://arxiv.org/abs/2605.00322)
...
### [38] [PAMod: Modeling Cyclical Shifts via Phase-Amplitude Modulation for Non-stationary Time Series Forecasting](https://arxiv.org/abs/2605.00466)
...
### [39] [Conformalized Quantum DeepONet Ensembles for Scalable Operator Learning with Distribution-Free Uncertainty](https://arxiv.org/abs/2605.00330)
...
### [40] [Scalable Context-Aware Graph Attention for Unsupervised Anomaly Detection in Large-Scale Mobile Networks](https://arxiv.org/abs/2605.00482)
...
### [41] [Borrowed Geometry: Computational Reuse of Frozen Text-Pretrained Transformer Weights Across Modalities](https://arxiv.org/abs/2605.00333)
*Abay Bektursun*
...
### [42] [Free Energy Surface Sampling via Reduced Flow Matching](https://arxiv.org/abs/2605.00337)
...
### [43] [Hierarchical Abstract Tree for Cross-Document Retrieval-Augmented Generation](https://arxiv.org/abs/2605.00529)
...
### [44] [Beyond Continuity: Simulation-free Reconstruction of Discrete Branching Dynamics from Single-cell Snapshots](https://arxiv.org/abs/2605.00545)
...
### [45] [Binomial flows: Denoising and flow matching for discrete ordinal data](https://arxiv.org/abs/2605.00360)
...
### [46] [Fairness of Classifiers in the Presence of Constraints between Features](https://arxiv.org/abs/2605.00592)
...
### [47] [Uniform-Correct Policy Optimization: Breaking RLVR's Indifference to Diversity](https://arxiv.org/abs/2605.00365)
...
### [48] [Possibilistic Predictive Uncertainty for Deep Learning](https://arxiv.org/abs/2605.00600)
...
### [49] [Learning Multimodal Energy-Based Model with Multimodal Variational Auto-Encoder via MCMC Revision](https://arxiv.org/abs/2605.00644)
...
### [50] [Group Cognition Learning: Making Everything Better Through Governed Two-Stage Agents Collaboration](https://arxiv.org/abs/2605.00370)
...
### [51] [AdaMeZO: Adam-style Zeroth-Order Optimizer for LLM Fine-tuning Without Maintaining the Moments](https://arxiv.org/abs/2605.00650)
...
### [52] [Advancing Edge Classification through High-Dimensional Causal Modeling of Node-Edge Interplay](https://arxiv.org/abs/2605.00374)
...
### [53] [Reinforcement Learning with Markov Risk Measures and Multipattern Risk Approximation](https://arxiv.org/abs/2605.00654)
...
### [54] [ResRL: Boosting LLM Reasoning via Negative Sample Projection Residual Reinforcement Learning](https://arxiv.org/abs/2605.00380)
...
### [55] [Augmented Lagrangian Multiplier Network for State-wise Safety in Reinforcement Learning](https://arxiv.org/abs/2605.00667)
...
### [56] [PILIR: Physics-Informed Local Implicit Representation](https://arxiv.org/abs/2605.00385)
...
### [57] [Meritocratic Fairness in Budgeted Combinatorial Multi-armed Bandits via Shapley Values](https://arxiv.org/abs/2605.00762)
...
### [113] [What is (H)CI: Why Does the "Human'' Matter?](https://arxiv.org/abs/2605.00109)
...
### [114] [Electrotactile Improves Thermal Referral](https://arxiv.org/abs/2605.00240)
...
### [115] [Engagement Phenotypes for a Sample of 102,684 AI Mental Health Chatbot Users and Dose-Response Associations with Clinical Outcomes](https://arxiv.org/abs/2605.00275)
...
### [116] [How Designers Envision Value-Oriented AI Design Concepts with Generative AI](https://arxiv.org/abs/2605.00280)
...
### [117] [Developing an AI Concept Envisioning Toolkit to Support Reflective Juxtaposition of Values and Harms](https://arxiv.org/abs/2605.00282)
...
### [118] [FaceValue: Exploring Real-Time Self-View Overlays to Prompt Meaning-Oriented Self-Awareness in Remote Meetings](https://arxiv.org/abs/2605.00288)
...
### [119] [From Phreaking to Sneaking: Children's Circumvention of Social Media Age Verification Systems](https://arxiv.org/abs/2605.00368)
...
### [120] [An eHMI Presenting Request-to-Intervene and Takeover Status of Level 3 Automated Vehicles to Support Surrounding Traffic Safety](https://arxiv.org/abs/2605.00377)
...
### [121] [Play and Learn: Gamified Feedback for Ultrasound-Guided Catheter Insertion Training in Virtual Reality](https://arxiv.org/abs/2605.00389)
...
### [122] [Urban to Rural Migration in Eastern Europe: Unpacking digital ruralities through TikTok video analysis](https://arxiv.org/abs/2605.00453)
...
### [123] ["What Are You Really Trying to Do?": Co-Creating Life Goals from Everyday Computer Use](https://arxiv.org/abs/2605.00497)
...
### [124] [The impact of coercive, normative, and mimetic Stress on Chinese teachers' continuance intention to use generative AI: An integrated perspective of the Expectation-Confirmation Model and Institutional Theory](https://arxiv.org/abs/2605.00522)
...
### [125] [Linking Behaviour and Perception to Evaluate Meaningful Human Control over Partially Automated Driving](https://arxiv.org/abs/2605.00556)
...
### [126] [DySRec: Dynamic Context-Aware Psychometric Scale Recommendation via Multi-Agent Collaboration](https://arxiv.org/abs/2605.00574)
...
### [127] [AI Washing Inflates Expected Performance but Not Interaction Outcomes: An AI Placebo Study Using Fitts' Law](https://arxiv.org/abs/2605.00582)
...
### [128] [Prop-Chromeleon: Adaptive Haptic Props in Mixed Reality through Generative Artificial Intelligence](https://arxiv.org/abs/2605.00804)
